...
`<PROJECT_ROOT>/.gemini/skills/managing-neo4j-knowledge-graph/scripts/_adhoc.py`
...
**Step 2.** Run it:
```bash
uv run --native-tls --env-file .env <PROJECT_ROOT>/.gemini/skills/managing-neo4j-knowledge-graph/scripts/_adhoc.py
```

**Step 3.** Delete the file after execution:
```bash
rm <PROJECT_ROOT>/.gemini/skills/managing-neo4j-knowledge-graph/scripts/_adhoc.py
```
...
```bash
uv run --native-tls --env-file .env <PROJECT_ROOT>/.gemini/skills/managing-neo4j-knowledge-graph/scripts/<script_name>.py
```
